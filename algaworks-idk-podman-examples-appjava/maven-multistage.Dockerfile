# Também poderia ser nomeado como "Containerfile"
...
ENV JAR_NAME=algaworks-idk-podman-examples-appjava-0.0.1-SNAPSHOT.jar \
    SERVER_PORT=8080 \
...
#
# Passos da execução:
# - Atualiza lista de pacotes e realiza instalação de tzdata, shadow-utils
...
# Comentado para remover warning referente a OCI image format (Utilizando o do compose)
